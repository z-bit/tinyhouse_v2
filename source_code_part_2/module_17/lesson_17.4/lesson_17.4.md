...
> To see a full list of data types TypeORM supports for each database system, head over to their [official documentation](https://github.com/typeorm/typeorm/blob/master/docs/entities.md#column-types)
...
> TypeORM has additional options for their find methods. To learn more, check out their [official documentation](https://github.com/typeorm/typeorm/blob/master/docs/find-options.md).
